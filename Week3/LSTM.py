...
# CS231n 강좌에서 python numpy 패키지만 활용해 구현해놓은 RNN 코드를 
# 손실함수를 바꿔 글자나 단어 단위로 학습하기 위한 LSTM 손실 함수를 만듦
# 출처: ratsgo.github.io

def lossFun(inputs, targets, hprev, cprev):
    xs, hs, cs, is_, fs, os, gs, ys, ps= {}, {}, {}, {}, {}, {}, {}, {}, {}
    hs[-1] = np.copy(hprev) # t=0일 때 t-1 시점의 hidden state가 필요하므로
    cs[-1] = np.copy(cprev)
    loss = 0
    H = hidden_size
    #forward pass
